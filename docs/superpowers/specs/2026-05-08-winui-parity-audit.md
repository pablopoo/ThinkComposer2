...
It is still not a complete legacy replacement. Remaining gaps are mostly release decisions: native PDF/XPS generation, real signing certificate provisioning, external update hosting, and broader end-to-end workflow automation.
